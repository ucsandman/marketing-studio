// sidetap OG statics: og.png (native 1200x630 still), the 8s animated
// og.mp4/og.gif loop, and the README GIF cut from the REAL demo footage
// (out/sidetap/demo.mp4 -- the approved live-iPhone capture, not a
...
// README GIF: cut from the real product-demo footage (out/sidetap/demo.mp4,
// live iPhone captured through the viewer -- NOT this composition). Segment
// 28.3s-37.0s of the 41.73s demo (props/sidetap-demo.json telemetry: "The
...
console.log('statics OK: og.png, og.mp4, og.gif, readme.gif in out/sidetap/');
