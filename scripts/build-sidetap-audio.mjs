// Source of truth for sidetap launch AUDIO copy: props/sidetap-audio.json is
...
// out/sidetap/marketing/brief.json, matching launchTiming.ts /
...
// Text mirrors out/sidetap/marketing/brief.json's narration array verbatim.
const LINES = [
