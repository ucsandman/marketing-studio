...
// stage cursor's click stack paints a yellow bloom and a yellow ring — and on
// this brand yellow is only ever a filled block carrying ink text. So the kit
// re-exports the GLYPH plus the travel math, and each shot composes the press
// feedback it wants out of ink.
//
...
/**
 * The stage glyph with its drop-shadow off. This brand has zero shadows, so the
 * kit's cursor is shadowless by default and a shot that genuinely wants the
 * shadow (saturated product UI) passes `style={{filter: undefined}}` back in.
 */
